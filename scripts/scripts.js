	...
	ymaps.ready(function() {
		...
		var placemarks = [{
			...
			, {
				...
				coords: [58.012622, 56.261397],
				header: 'Танцевальный клуб "Шаг вперёд"',
				text: 'Бизнес центр "Луначарский", 10-й этаж',
				...
				coords: [57.972950, 56.262051],
				header: 'Школа №94',
				text: '',
				address: 'улица Героев Хасана, 89',
				schedule: '',
				imageUrl: ''
			}
