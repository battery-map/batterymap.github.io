...
jQuery.ketchup.validation("required", "Это поле должно быть заполнено.", function(g, b, c) {
	...
	return c.length <= +d
}).validation("rangelength", "Это поле дожно иметь длину от {arg1} до {arg2} символов.", function(g,
	b, c, d, h) {
	...
	"Должен быть корректный E-Mail.", function(g, b, c) {
